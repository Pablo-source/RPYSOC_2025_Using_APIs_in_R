...
- After requesting and obtaining my API Key I can start querying specific Weather information using the AEMET OpenData API, such as daily temperatures for specific cities in Spain: 
